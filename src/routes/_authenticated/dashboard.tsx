    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {statsQuery.isLoading
          ...
          : (
            <>
              <StatCard
                label={isAdvertiser ? "Active campaigns" : "Accepted gigs"}
                value={statsQuery.data?.active ?? 0}
                icon={Megaphone}
              />
              <StatCard
                label={isAdvertiser ? "Applications" : "Applications sent"}
                value={statsQuery.data?.applications ?? 0}
                icon={Users}
              />
              <StatCard
                label="Pending"
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            to={isAdvertiser ? "/discover" : "/campaigns"}
